            ...
            <div class="main-content" id="main-content" :style="{height: (getWinHeight-60)+'px'}">
                <div class="main-feature">
                    <div class="main-inner">
                        <h1 class="ly-title-one" style="margin-bottom: 40px">导入设备</h1>
                        <div class="form-list">
                                    ...
                                    <div style="position: relative">
                                        ...
                                        <div class="importBox">
                                            ...
                                            <el-upload
                                                    ...
                                                    :file-list="fileList">
                                                <el-button size="small" type="primary" @click="getToken">批量导入</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            handleSuccess(res, file, fileList) {
                ...
                console.log(this.importStatus,this.form.file)
            },
            // 文件上传失败时的钩子
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        if (this.importStatus) {
                            //    录入多个
                            api = '/admin/devices/add/batch';
                        } else {
                            //    录入一个
                            api = '/admin/devices/add/one'
                        }
                        ...
                        this.$axios.post(api,this.form).then(res => {
                            ...
                            if (res.data.code === this.$webConfig.httpSuccessStatus) {
                                ...
                                this.$router.push('/device/storage');
                            }else {
