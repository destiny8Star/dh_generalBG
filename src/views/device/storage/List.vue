    ...
    <div>
        <div class="main-right" id="main-right" :style="{height: (getWinHeight-60) + 'px'}">
            ...
            <div style="display: flex;align-items: center;justify-content: space-between">
                <div class="third-nav-t">入库列表</div>
                    ...
                    <div class="main-inner" v-loading="loading">
                        ...
                        <el-form :inline="true" :model="postData" class="demo-form-inline">
                            <el-row>
                                <el-form-item label="入库编号">
                                    <el-input v-model="postData.order_no"></el-input>
                                </el-form-item>
                                ...
                                <el-form-item>
                                    <el-button size="small" type="primary" @click = "$router.push('/device/importDevice')">导入设备</el-button>
                                </el-form-item>
                            </el-row>
                        </el-form>
                        <!--搜索条件 end -->
                        ...
                        <template>
                            <el-table ref="multipleTable" :data="tableData" style="width: 100%;min-width: 780px;"
                                ...
                                <el-table-column prop="order_no" label="入库编号">
                                </el-table-column>
                                <el-table-column prop="put_in_time" label="入库时间">
                                </el-table-column>
                                <el-table-column prop="device_count" label="入库设备数">
                                </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleClick(data) {
                console.log(data);
                this.$router.push({path:'/device/storage/detail',query:{orderNo:data.order_no}})
            },
            onSubmit() {
                console.log('submit!');
            ...
            //获取topdata
            getTop(){
                this.$axios.post('/admin/devices/put/in/order/top')
                    .then(res=>{
            ...
            getData() {
                this.loading = true;
                //初始化列表
                this.$axios.post('/admin/devices/put/in/order', this.postData).then(res => {
                    this.loading = false;
                    console.log(res);
                    if (res.data.code === this.$webConfig.httpSuccessStatus) {
