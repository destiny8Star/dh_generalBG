    ...
    <div>
        <div class="main-right" id="main-right" :style="{height: (getWinHeight-60) + 'px'}">
            <div style="display: flex;align-items: center;justify-content: space-between">
                <div class="third-nav-t">回收详情（ {{'编号 ' + postData.order_no}} ）</div>
                <el-button style="margin: 0 30px" size="small" type="primary" @click = "$router.push('/device/recycle')">返回</el-button>
            </div>
...
<script>
    ...
    export default {
        ...
        data(){
            return {
                //1：入库，2：回收（分配给代理商），3：分配给商户，4：分配给门店，5：回收（代理退给总后台），6：退回（商户退给代理商）
