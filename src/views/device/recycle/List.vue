    ...
    <div>
        <div class="main-right" id="main-right" :style="{height: (getWinHeight-60) + 'px'}">
            ...
            <div style="display: flex;align-items: center;justify-content: space-between">
                <div class="third-nav-t">回收列表</div>
                    ...
                    <div class="main-inner" v-loading="loading">
                        ...
                        <el-form :inline="true" :model="postData" class="demo-form-inline"
                            ...
                            <el-row>
                                <el-form-item label="回收编号">
                                    <el-input v-model="postData.order_no" placeholder="请输入回收编号"></el-input>
                                </el-form-item>
                                ...
                                <el-form-item>
                                    <el-button type="primary" @click="onSubmit()" size="small" v-loading="submitState">
                                        查询
                                    </el-button>
                                </el-form-item>
                            </el-row>
                        ...
                        <template>
                            <el-table ref="multipleTable" :data="tableData" style="width: 100%;min-width: 780px;"
                                ...
                                <el-table-column prop="order_no" label="回收编号">
                                </el-table-column>
                                <el-table-column prop="out_time" label="回收时间">
                                </el-table-column>
                                <el-table-column prop="device_count" label="回收设备数">
                                </el-table-column>
                                <el-table-column prop="agent_name" label="回收对象">
                                </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleClick(data) {
                console.log(data);
                this.$router.push({path: '/device/recycle/detail', query: {orderNo: data.order_no}})
            },
            /**
             * 查询
             */
