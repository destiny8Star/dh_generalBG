            ...
            <div class="main-content" id="main-content" :style="{height: (getWinHeight-60)+'px'}">
                <div class="main-feature">
                    <div class="main-inner" :style="{minHeight: (getWinHeight-20)+'px'}">
                        <h1 class="ly-title-one">商户进件详情（微信直连） <el-button type="primary" size="mini" style="float: right;margin-top: 10px" @click="$router.push('/merchant/weChatAudit')">返回</el-button> </h1>
                        <div class="infoBox">
                        ...
                        <div class="form-list" style="margin-top: 30px;" v-if="status==3">
                            <el-form :model="form" label-width="120px" ref="form" :rules="rules">
                                <el-form-item label="微信商户号:" prop='wx_store_no'>
                                    <el-input v-model="form.wx_store_no" placeholder="请输入微信商户号"></el-input>
                                </el-form-item>
                                <el-form-item label="微信费率:" prop='wx_rate' type='number'>
                                    <el-input v-model="form.wx_rate" placeholder="费率为0.38%~0.6%之间"
                                              @keyup.native='winpChange'></el-input>
                                </el-form-item>
    ...
    export default {
        ...
        data: function () {
            ...
            let checkNull = (rule, value, callback) => {
                if (value.trim() == '') {
                    return callback(new Error('请输入微信商户号'));
                } else {
                    callback();
                }
            };
